<script lang="ts">
	...
	function handleSearch() {
	  ...
	  profiles = data.usersRes?.users.filter(person => {
  ...
  <section>
	<h1 class="text-4xl font-bold mb-6 text-center">
	  ...
	  <div class="flex px-20 my-4">
		 <input type="text" id="searchInput" placeholder="Search profiles" class="flex border w-full border-gray-300 rounded-md py-3 px-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" on:input={handleSearch} />
